                                                ...
                                                <table id="sales-table" class="table table-vcenter table-condensed table-bordered">
                                                    ...
                                                    @foreach($totalSoldProductsSales as $product=>$quantity)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                @if (\App\Employee::target(Request::segment(4), \App\Product::select('id')->where('name', $product)->first()->id, \App\Territory::select('id')->where('mr_id', \Request::segment(3))->first()->id))
                                                                    {{\App\Employee::target(Request::segment(4), \App\Product::select('id')->where('name', $product)->first()->id, \App\Territory::select('id')->where('mr_id', \Request::segment(3))->first()->id)}}
                                                                @endif
                                                            </td>
                                                            <td class="text-center">
