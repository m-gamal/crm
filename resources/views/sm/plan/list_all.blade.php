...
@section('content')
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{URL::route('smPlans')}}">All Plans</a></li>
    </ul>
    <!-- END Breadcrumb -->
    ...
    <div class="row">
        ...
        <div class="block">
            ...
            <div class="block-title">
                <h2>
                    Planned Visits
                    <a href="{{URL::route('smAddPlan')}}" class="label label-success" title="Add New Plan">+</a>
                </h2>
...
<script>
    ...
    var config = {
        routes: [
            { plan: "{{URL::route('smAjaxPlans') }}"}
        ]
    };
</script>
<script src="{{URL::asset('js/sm/plan.js')}}"></script>
@endsection