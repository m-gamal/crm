...
@section('title')
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{URL::route('smPendingLeaveRequests')}}">All Pending Leave Requests</a></li>
    </ul>
    <!-- END Breadcrumb -->
                    ...
                    @foreach($pendingLeaveRequests as $singleLeaveRequests)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a class="btn btn-xs btn-success" href="{{URL::route('smApprovePendingLeaveRequest', $singleLeaveRequests->id)}}"title="Approve">
                                        <i class="fa fa-check"></i>
                                    </a>
                                    <a class="btn btn-xs btn-danger" href="{{URL::route('smDeclinePendingLeaveRequest', $singleLeaveRequests->id)}}" title="Reject">
