...
@section('content')
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{URL::route('coverage')}}">All Coverage</a></li>
    </ul>
    <!-- END Breadcrumb -->
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><strong>Search On Coverage </strong></h2>
                </div>
    ...
    <div class="block full">
        <div class="block-title">
            ...
            <h2>
                <strong>All</strong> Coverage Results
            </h2>
...
<script>$('#coverage').addClass('active');</script>
