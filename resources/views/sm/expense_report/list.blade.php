...
@section('content')
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{URL::route('smExpensesReports')}}">All Expenses Reports</a></li>
    </ul>
    <!-- END Breadcrumb -->
    ...
    <div class="block full">
        <div class="block-title">
            <h2>
                ...
                <a href="{{URL::route('smAddExpenseReport')}}" class="label label-success" title="Add New Expense Report">+</a>
            </h2>
