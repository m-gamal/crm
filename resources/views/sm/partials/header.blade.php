                ...
                @foreach($unread as $singleMessage)
                    <li>
                        <div class="alert alert-success alert-alt">
                            <a href="{{URL::route('smShowMessage', $singleMessage->id)}}">
