        ...
        <div class="block">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="areas">
                    {!!
                    Form::open([
                        'route'     =>  array('doUpdateProductsTarget',$productTarget->id),
                        'method'    =>  'post',
                    ...
                    !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <span class="help-block">
                                    Original Quantity : <span><strong id="original">0</strong></span> Units
                                    <br>
                                    Remaining Quantity for this territory : <span><strong id="remaining">0</strong></span> Units
                                </span>
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="example-text-input">Percentage</label>
                            <div class="col-md-8">
                                <input type="text" id="percentage" name="percentage" class="form-control" value="{{ old('percentage') }}">
                                <span class="help-block">
                                    Quantity of this percentage of the product is
                                    <span><strong id="percentage_quantity">0</strong></span>
                                    Units
                                </span>
                                @if($errors->has('percentage'))
                                    <div class="alert alert-danger">
                                        <i class="fa fa-warning"></i>
                                        <strong>Error :</strong> {{$errors->first('percentage')}}
                                    </div>
                                @endif
                            </div>
                        </div>
...
<script>$('#set_products_target').addClass('active');</script>
