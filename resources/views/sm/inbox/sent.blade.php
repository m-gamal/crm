        ...
        <div class="block full">
            ...
            <div class="block-title clearfix">
                <div class="block-options pull-left">
                    <a href="{{URL::route('smCreateMessage')}}" class="btn btn-alt btn-sm btn-default"><i class="fa fa-pencil"></i> Compose Message</a>
                </div>
            </div>
            <!-- END Menu Title -->
            ...
            <ul class="nav nav-pills nav-stacked">
                <li>
                    <a href="{{URL::route('smInbox')}}">
                        <i class="fa fa-angle-right fa-fw"></i> <strong>Inbox</strong>
                    </a>
                </li>

                <li class="active">
                    <a href="{{URL::route('smSentMessages')}}">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-vcenter">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{URL::route('smShowMessage', $singleMessage->id)}}"><strong>{{$singleMessage->subject}}</strong></a>
                        </td>
