...
@section('title')
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{URL::route('amPendingServicesRequests')}}">All Pending Service Requests</a></li>
    </ul>
    <!-- END Breadcrumb -->
                    ...
                    @foreach($pendingServicesRequests as $singleServiceRequests)
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a class="btn btn-xs btn-success" href="{{URL::route('amApprovePendingServiceRequest', $singleServiceRequests->id)}}"title="Approve">
                                        <i class="fa fa-check"></i>
                                    </a>
                                    <a class="btn btn-xs btn-danger" href="{{URL::route('amDeclinePendingServiceRequest', $singleServiceRequests->id)}}" title="Reject">
