...
@section('content')
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{URL::route('amServicesRequests')}}">All Services Requests</a></li>
    </ul>
    <!-- END Breadcrumb -->
    ...
    <div class="block full">
        <div class="block-title">
            <h2>
                ...
                <a href="{{URL::route('amAddServiceRequest')}}" class="label label-success" title="Add New Service Request">+</a>
            </h2>
        </div>
