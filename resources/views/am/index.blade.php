            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="block-section">
                        <a href="{{URL::route('amSalesSearch')}}" class="btn btn-block btn-success btn-lg">
                ...
                <div class="col-md-4">
                    <div class="block-section">
                        <a href="{{URL::route('amCoverageSearch')}}" class="btn btn-block btn-success btn-lg">
                ...
                <div class="col-md-4">
                    <div class="block-section">
                        <a href="{{URL::route('amReportSearch')}}" class="btn btn-block btn-success btn-lg">
                            <i class="fa fa-files-o"></i>
                            Report Search
                        </a>
                    </div>
