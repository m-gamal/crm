            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active" id="areas">
                    ...
                    !!}
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label" for="example-select">Select Product Target
                            </label>
                            <div class="col-md-10">
                                <select name="product_target" class="form-control select-chosen">
                                    <option value="">Select Product Target</option>
                                    @foreach($productsTargets as $singleProductTarget)
                                        <option value="{{$singleProductTarget->id}}" @if (old('products_targets') == $singleProductTarget->id) selected="selected" @endif>
                                            [Year : {{$singleProductTarget->year}}]
                                            [Line : {{$singleProductTarget->line->title}}]
                                            [Product : {{$singleProductTarget->product->name}}]
                                            [Product Quantity : {{$singleProductTarget->quantity}}]
                                        </option>
                                    @endforeach
                                </select>
                                @if($errors->has('line'))
...
<script>$('#set_area_target').addClass('active');</script>
