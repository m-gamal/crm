        ...
        <div class="block full">
            ...
            <div class="block-title clearfix">
                <div class="block-options pull-left">
                    <a href="{{URL::route('amCreateMessage')}}" class="btn btn-alt btn-sm btn-default"><i class="fa fa-pencil"></i> Compose Message</a>
                </div>
            </div>
            <!-- END Menu Title -->
            ...
            <ul class="nav nav-pills nav-stacked">
                <li>
                    <a href="{{URL::route('amInbox')}}">
                        <i class="fa fa-angle-right fa-fw"></i> <strong>Inbox</strong>
                    </a>
                </li>

                <li class="active">
                    <a href="{{URL::route('amSentMessages')}}">
        ...
        <div class="block">
            ...
            <div class="table-responsive">
                <table class="table table-hover table-vcenter">
                    ...
                    <tr>
                        <td style="width: 20%;">{{\App\Employee::findOrFail($singleMessage->receiver)->name}}</td>
                        <td>
                            <a href="{{URL::route('amShowMessage', $singleMessage->id)}}"><strong>{{$singleMessage->subject}}</strong></a>
                        </td>
