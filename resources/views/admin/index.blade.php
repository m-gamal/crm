        ...
        <div class="header-section">
            <div class="row">
                ...
                <div class="col-md-4 col-lg-6 hidden-xs hidden-sm">
                    <h1>Welcome <strong>Admin</strong><br><small>Manage Reports Effectively</small></h1>
                </div>
                <!-- END Main Title -->
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="block-section">
                        <a href="{{URL::route('adminSalesSearch')}}" class="btn btn-block btn-success btn-lg">
                ...
                <div class="col-md-4">
                    <div class="block-section">
                        <a href="{{URL::route('adminCoverageSearch')}}" class="btn btn-block btn-success btn-lg">
                ...
                <div class="col-md-4">
                    <div class="block-section">
                        <a href="{{URL::route('adminReportSearch')}}" class="btn btn-block btn-success btn-lg">
                            <i class="fa fa-files-o"></i>
                            Report Search
                        </a>
                    </div>
