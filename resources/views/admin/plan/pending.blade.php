...
@section('title')
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{URL::route('adminSMPendingPlans')}}">All Plans</a></li>
    </ul>
    <!-- END Breadcrumb -->
                ...
                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                    ...
                    @foreach($pendingPlans as $singlePlan)
                        <tr>
                            ...
                            <td class="text-center">{{$singlePlan->sm->name}}</td>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a class="btn btn-xs btn-success" href="{{URL::route('adminApproveSMPendingPlan', $singlePlan->id)}}"title="Approve">
                                        <i class="fa fa-check"></i>
                                    </a>
                                    <a class="btn btn-xs btn-danger" href="{{URL::route('adminDeclineSMPendingPlan', $singlePlan->id)}}" title="Reject">
