            ...
            <div class="block">
                ...
                !!}
                        ...
                        <div class="col-md-10">
                            <select id="example-chosen" name="mr" class="select-chosen">
                                ...
                                @foreach($MRs as $singleMR)
                                    <option value="{{$singleMR->id}}" @if($singleMR->id == $territory->mr_id) selected @endif>
                                        {{$singleMR->name}}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <textarea type="text" rows="5" name="description" class="form-control">{{$territory->description}}</textarea>
