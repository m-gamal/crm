...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{URL::route('addTerritory')}}">Add New Territory</a></li>
    </ul>
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <div class="block">
                ...
                <div class="block-title">
                    <h2><strong>Add New </strong> Territory</h2>
                </div>
                        ...
                        <div class="col-md-10">
                            <select id="example-chosen" name="area" class="select-chosen">
                                ...
                                @foreach($areas as $singleArea)
                                    <option value="{{$singleArea->id}}" @if (old('area') == $singleArea->id) selected="selected" @endif>{{$singleArea->name}}</option>
                                @endforeach
                            </select>
                            @if($errors->has('area'))
                                <div class="alert alert-danger">
