    ...
    <ul class="nav navbar-nav-custom pull-right">
        ...
        <li>
            <a href="javascript:void(0)" data-toggle="dropdown" class="dropdown-toggle">
                <i class="fa fa-bell fa-2x" @if($smPendingRequests ==1 ) style="color:red; font-size: 18px;" @endif></i>
            </a>
            <ul class="dropdown-menu dropdown-custom dropdown-menu-right">
                <li>
                    <div class="alert alert-info alert-alt">
                        <a href="{{URL::route('adminSMPendingPlans')}}">
                            <i class="fa fa-calendar"></i> Review {{$smCountPendingPlans}} Pending Plans
                        </a>
                    </div>

                    <div class="alert alert-info alert-alt">
                        <a href="{{URL::route('adminSMPendingLeaveRequests')}}">
                            <i class="fa fa-sign-out"></i> Review {{$smCountPendingLeaveRequests}} Pending Leave Request
                        </a>
                    </div>

                    <div class="alert alert-info alert-alt">
                        <a href="{{URL::route('adminSMPendingServicesRequests')}}">
                            <i class="fa fa-reply"></i> Review {{$smCountPendingServicesRequest}} Pending Service Request
                        </a>
                    </div>
                </li>
            </ul>
