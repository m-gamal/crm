...
@section('title')
    ...
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{URL::route('adminSMPendingServicesRequests')}}">All Pending Service Requests</a></li>
    </ul>
    <!-- END Breadcrumb -->
                ...
                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                    ...
                    @foreach($pendingServicesRequests as $singleServiceRequests)
                        <tr>
                            ...
                            <td class="text-center">{{$singleServiceRequests->sm->name}}</td>
                            <td class="text-center">{{$singleServiceRequests->date}}</td>
                            <td class="text-center">{{$singleServiceRequests->request_text}}</td>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a class="btn btn-xs btn-success" href="{{URL::route('adminApproveSMPendingServiceRequest', $singleServiceRequests->id)}}"title="Approve">
                                        <i class="fa fa-check"></i>
                                    </a>
                                    <a class="btn btn-xs btn-danger" href="{{URL::route('adminDeclineSMPendingServiceRequest', $singleServiceRequests->id)}}" title="Reject">
