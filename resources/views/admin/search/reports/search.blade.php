...
@section('content')
    <ul class="breadcrumb breadcrumb-top">
        ...
        <li><a href="{{URL::route('adminReportSearch')}}">Reports Search</a></li>
    </ul>
                ...
                <div class="block">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="mr_tab">
                            ...
                            <div class="form-group" id="sold_product_form">
                                <label class="col-md-2 control-label">Has Double Visit</label>
                                <div class="col-md-10">
                                    <input type="checkbox" name="double_visit" value="1">
                                    @if($errors->has('double_visit'))
                                        <div class="alert alert-danger">
                                            <i class="fa fa-warning"></i>
                                            <strong>Error :</strong> {{$errors->first('double_visit')}}
                                        </div>
                                    @endif
                                </div>
                            </div>
