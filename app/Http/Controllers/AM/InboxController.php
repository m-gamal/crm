...
class InboxController extends Controller
{
    public function all()
    {
        ...
        return view ('am.inbox.all', $dataView);
    }
    ...
    public function create()
    {
        ...
        return view('am.inbox.new', $dataView);
    }
    ...
    public function sent()
    {
        ...
        return view('am.inbox.sent', $dataView);
    }
    ...
    public function show($id)
    {
        ...
        return view('am.inbox.show', $dataView);
    }
    ...
    public function doReply(CreateReplyRequest $request, $id){
        ...
        try {
            ...
            return redirect()->route('amShowMessage', $id)->with('message','Message has been sent successfully !');
        } catch (ParseException $ex) {
            echo 'Failed to send message , with error message: ' . $ex->getMessage();
        }
    }
