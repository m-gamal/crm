...
class ReportController extends Controller
{
    ...
    {
        return view('am.report.requests_lists');
    }
    ...
    public function search()
    {
        ...
        return view('am.search.reports.search', $dataView);
    }
    ...
    public function MRSearch()
    {
        ...
        return view('am.search.reports.mr_search', $dataView);
    }
    ...
    public function doMRSearch(ReportSearchRequest $request)
    {
        ...
        return view('am.search.reports.mr_result', $dataView);
    }
    ...
    public function create($doctorId = NULL)
    {
        ...
        return view ('am.report.create', $dataView);
    }
    ...
    {
        return view ('am.expense_report.create');
    }
    ...
    public function doCreateExpenseReport(CreateExpenseReportRequest $request)
    {
        ...
        try {
            if ($expenseReport->save()) {
                ...
                ->move(public_path('uploads/expenses_reports/4/' . $expenseReport->month . '/'), $expenseReport->date . '.' . $extension);
            }
    ...
    public function listAllExpensesReports()
    {
        ...
        return view('am.expense_report.list', $dataView);
    }
    ...
    public function listAllLeaveRequests()
    {
        ...
        return view('am.leave_request.list', $dataView);
    }

    public function createLeaveRequest()
    {
        return view ('am.leave_request.create');
    }
    ...
    public function listAllServicesRequests()
    {
        ...
        return view('am.service_request.list', $dataView);
    }

    public function createServiceRequest()
    {
        return view ('am.service_request.create');
    }
