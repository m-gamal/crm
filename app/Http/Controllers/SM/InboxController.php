...
class InboxController extends Controller
{
    public function all()
    {
        ...
        return view ('sm.inbox.all', $dataView);
    }
    ...
    public function create()
    {
        ...
        return view('sm.inbox.new', $dataView);
    }
    ...
    public function sent()
    {
        ...
        return view('sm.inbox.sent', $dataView);
    }
    ...
    public function show($id)
    {
        ...
        return view('sm.inbox.show', $dataView);
    }
    ...
    public function doReply(CreateReplyRequest $request, $id){
        ...
        try {
            ...
            return redirect()->route('smShowMessage', $id)->with('message','Message has been sent successfully !');
        } catch (ParseException $ex) {
            echo 'Failed to send message , with error message: ' . $ex->getMessage();
        }
    }
