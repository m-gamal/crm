...
class LineController extends Controller
{
    public function listAll()
    {
        ...
        return view('sm.line.list', $dataView);
    }
    ...
    public function single($mr, $currentMonth)
    {
        ...
        return view('sm.line.single', $dataView);
    }
    ...
    public function update($id)
    {
        ...
        return view('sm.line.edit', $dataView);
    }
    ...
    public function doAchievement(MRAchievementRequest $request)
    {
        ...
        return Redirect::route('smSingleLine', array($mr, \Carbon\Carbon::parse($month)->format('M-Y')));
    }
}
